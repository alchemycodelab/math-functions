...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const multiply3 = multiply((multiply(multArr[0], multArr[1])[0]), multArr[2])[0];
    const mult3String = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + multiply3 + '.';
    const mult3Array = [multiply3, mult3String];
    return mult3Array;
}
