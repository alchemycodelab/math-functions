...
export function sum(a, b) {
    let array = [];
    array.push(a + b, `The sum of ${a} and ${b} is ${a + b}.`);
    return array;
}
...
export function multiply(a, b) {
    let array = [];
    array.push(a * b, `The product of ${a} and ${b} is ${a * b}.`);
    return array;
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    let multiplyResult = multiply(a, b)[0];
    multiplyResult = multiply(multiplyResult, c)[0];
    array.push(sumResult);
    array.push(multiplyResult);
    array.push(`${a} and ${b} and ${c} sum to ${sumResult}.`);
    array.push(`The product of ${a} and ${b} and ${c} is ${multiplyResult}.`);
    return array;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    for (let num of multArr) {
        multiplyResult = multiply(multiplyResult, num)[0];
    }
    array.push(multiplyResult);
    array.push(`The numbers ${multArr.join(',')} have a product of ${multiplyResult}.`);
    return array;
}
