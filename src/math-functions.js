...
export function sum(a, b) {
    const array = [(a + b), `The sum of ${a} and ${b} is ${a + b}.`];
    return array;
}
...
export function multiply(a, b) {
    const arrayTwo = [(a * b), `The product of ${a} and ${b} is ${a * b}.`];
    return arrayTwo;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const b = multArr[1];
    const c = multArr[2];
    const productOfArr = multiply(a, b)[0];
    const finalProductArr = multiply(c, productOfArr)[0];
    const arrayFive = [finalProductArr, `The numbers ${multArr} have a product of ${finalProductArr}.`];
    return arrayFive;
}

// Once you get the test passing, do an a-c-p cycle and synchronize the code between 
//GitHub and your laptop. 

// You're done! Submit the link to the repo following the instructions in Canvas. Or, 
// try out the stretch goal below...
