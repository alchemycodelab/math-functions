...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const sumTwo = sum(c, sumOne[0]);
    const sumTotal = sumTwo[0];
    const multiplyOne = multiply(a, b);
    const multiplyTwo = multiply(c, multiplyOne[0]);
    const multiplyTotal = multiplyTwo[0];
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sumTwo = sum(sumArr[2], sumOne[0]);
    return [sumTwo[0], `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumTwo[0]} is their sum.`];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const productTwo = multiply(multArr[2], productOne[0]);
    return [productTwo[0], `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${productTwo[0]}.`];
}
