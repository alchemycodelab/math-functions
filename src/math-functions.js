...
export function sum(a, b) {
    ...
    returnArray.push(`The sum of ${a} and ${b} is ${returnArray[0]}.`);
    return returnArray;
...
export function multiply(a, b) {
    const returnArray = [];
    returnArray.push(a * b);
    returnArray.push(`The product of ${a} and ${b} is ${returnArray[0]}.`);
    return returnArray;
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const returnArray = [];
    returnArray.push(sum(sum(a, b)[0], c)[0]);
    returnArray.push(multiply(multiply(a, b)[0], c)[0]);
    returnArray.push(`${a} and ${b} and ${c} sum to ${returnArray[0]}.`);
    returnArray.push(`The product of ${a} and ${b} and ${c} is ${returnArray[1]}.`);
    return returnArray;
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    let accumulator = 0;
    for(let i of sumArr) {
        accumulator = sum(accumulator, i)[0];
    }
    returnArray.push(accumulator);
    returnArray.push(`${sumArr} was passed in as an array of numbers, and ${returnArray[0]} is their sum.`);
    return returnArray;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    returnArray.push(accumulator);
    returnArray.push(`The numbers ${multArr} have a product of ${returnArray[0]}.`);
    return returnArray;
}
