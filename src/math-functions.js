...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const firstPartSum = sum(a, b)[0];
    const finalSum = sum(firstPartSum, c)[0];
    const firstPartProduct = multiply(a, b)[0];
    const finalProduct = multiply(firstPartProduct, c)[0];
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const firstTwoArrayNumbers = sum(sumArr[0], sumArr[1]);
    const arrayTotal = sum(firstTwoArrayNumbers[0], sumArr[2])[0];
    return [arrayTotal, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${arrayTotal} is their sum.`];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    return [multTotal[0], `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${multTotal[0]}.`];
}
