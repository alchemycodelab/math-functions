...
export function sum(a, b) {
    const added = a + b;
    const statement = 'The sum of ' + a + ' and ' + b + ' is ' + added + '.';
...
export function multiply(a, b) {
    const product = a * b;
    const statement = 'The product of ' + a + ' and ' + b + ' is ' + product + '.';

    return [product, statement];
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const sumAB = sum(a, b);
    const sumXC = sum(sumAB[0], c);
    const sumABC = sumXC[0];
    const prodAB = multiply(a, b);
    const prodXC = multiply(prodAB[0], c);
    const prodABC = prodXC[0];

    const sumStatement = a + ' and ' + b + ' and ' + c + ' sum to ' + sumABC + '.';
    const prodStatement = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prodABC + '.';

    return [sumABC, prodABC, sumStatement, prodStatement];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    const sum01 = sum(sumArr[0], sumArr[1]);
    const sum12 = sum(sum01[0], sumArr[2]);
    const statement = 'The numbers ' + sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' have a sum of ' + sum12[0] + '.';

    return [sum12[0], statement];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const prod01 = multiply(multArr[0], multArr[1]);
    const prod12 = multiply(prod01[0], multArr[2]);
    const statement = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + prod12[0] + '.';

    return [prod12[0], statement];
}
