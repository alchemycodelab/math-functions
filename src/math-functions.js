...
export function sum(a, b) {
    let c = a + b; 
    return [c, 'The sum of ' + a + ' and ' + b + ' is 11.'];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    let a = parseInt(sum(sumArr[0], sumArr[1]));
    let b = parseInt(sum(a, sumArr[2]));

    return [b, 'The numbers ' + sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' have a sum of ' + b + '.'];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    let c = parseInt(multiply(multArr[0], multArr[1]));
    let d = parseInt(multiply(c, multArr[2]));

    return [24, 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + d + '.'];
}
