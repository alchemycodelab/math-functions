...
export function sum(a, b) {
    ...
    const returnArray = [];
    const addedTogether = a + b;
    const string = `The sum of ${a} and ${b} is ${addedTogether}.`;

    returnArray.push(addedTogether);
...
export function multiply(a, b) {
    ...
    returnArray.push(product, string);
    return returnArray;
}
