...
export function sumArrayWithThreeNumbers(sumArr) {
    let sum2 = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0];
    return [
        sum2,
        `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sum2} is their sum.`];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    let product2 = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
    return [
        product2, 
        `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${product2}.`
    ];
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    for(let i = 0; i < dynamicArray.length; i++) {
        for(let j = 1; j < i; j++) {
            ...
            let stuff = multiply(dynamicArray[i], dynamicArray[j])[0];
            console.log(stuff);
        ...
        // let product3 = multiply(dynamicArray[i], (i))[0];
        // let someArray = [
        //     product3,
        //     `The numbers ${dynamicArray[i]} have a product of ${product3}.`
        // ];
