...
export function sum(a, b) {
    const sum = a + b;
    const string = 'The sum of 4 and 7 is ' + sum + '.';
    const array = [sum, string];
    return array;
}
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const sum = a + b + c;
    const product = a * b * c;
    const string1 = '4 and 7 and 5 sum to ' + sum + '.';
    const string2 = 'The product of 4 and 7 and 5 is ' + product + '.';
    const array = [sum, product, string1, string2];
    return array;
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const secondSum = sum(firstSum, sumArr[2]) [0];
    return [secondSum, 'The numbers ' + sumArr + ' have a sum of 9.'];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const secondProduct = multiply(firstProduct, multArr[2]) [0];
    return [secondProduct, 'The numbers ' + multArr + ' have a product of 24.'];
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    //     total = total + sumArr[i]; // total += sumArr[i];
    // }
    // return total;
