...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    resultsArr.push(multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0]);

    resultsArr.push(`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${resultsArr[0]}.`);
