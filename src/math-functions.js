...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const secondSum = sum(c, firstSum)[0];
    const firstProduct = multiply(a, b)[0];
    const secondProduct = multiply(c, firstProduct)[0];
    return [secondSum, secondProduct, `${a} and ${b} and ${c} sum to ${secondSum}.`, `The product of ${a} and ${b} and ${c} is ${secondProduct}.`];
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const secondSum = sum(sumArr[2], firstSum)[0];
    return [secondSum, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${secondSum} is their sum.`];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    const firstProduct = multiply(multArr[0], multArr[1])[0];
    const secondProduct = multiply(multArr[2], firstProduct)[0];
    return [secondProduct, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${secondProduct}.`];
}
