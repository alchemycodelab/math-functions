...
export function sum(a, b) {
    ...
    const addition = a + b;
    const aString = `The sum of ${a} and ${b} is ${addition}.`;

    returnArray.push(addition);
    returnArray.push(aString);
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const prodString = `The product of ${a} and ${b} and ${c} is ${prodOfThree}.`;
    const resultsArray = [sumOfThree, prodOfThree, sumString, prodString];
    return resultsArray;
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sumArrayString = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumOfThree} is their sum.`;
    return [sumOfThree, sumArrayString];
...
export function multiplyArrayWithThreeNumbers(multArr) {
    ...
    const prodArrayString = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${prodOfThree}.`;
    return [prodOfThree, prodArrayString];
}
