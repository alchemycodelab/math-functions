...
export function sum(a, b) {
    const sumArray = [];
    const sumTotal = a + b;
    const sumString = `The sum of ${a} and ${b} is 11.`;
    sumArray[0] = sumTotal;
...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    ...
    const totalMult = multiply(firstMult[0], c);

    sumMultArray[0] = totalSum[0];
    sumMultArray[1] = totalMult[0];
    sumMultArray[2] = `${a} and ${b} and ${c} sum to 16.`;
    sumMultArray[3] = `The product of ${a} and ${b} and ${c} is 140.`;
    return sumMultArray;
}
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const totalSum = sum(firstSum[0], sumArr[2]);

    sumArray[0] = totalSum[0];
    sumArray[1] = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and 9 is their sum.`;
    return sumArray;
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const totalMult = multiply(firstMult[0], multArr[2]);

    productArr[0] = totalMult[0];
    productArr[1] = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${productArr[0]}.`;
    return productArr;
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    finalArray[1] = `The numbers ` + arrayString + ` have a product of ${finalArray[0]}.`;
    return finalArray;
}
