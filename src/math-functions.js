...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const sumNumbers = sum(a, b)[0];
    const arraySum = sum(sumNumbers, c);
    const sumTotal = arraySum[0];
    const multiplyNumbers = multiply(a, b)[0];
    const arrayMultiply = multiply(multiplyNumbers, c);
    const multiplyTotal = arrayMultiply[0];
...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const c = sumArr[2];
    const sumNumbers = sum(a, b)[0];
    const arraySum = sum(sumNumbers, c)[0];
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const b = multArr[1];
    const c = multArr[2];
    const multNumbers = multiply(a, b)[0];
    const arrayMultiply = multiply(multNumbers, c)[0];
    return [arrayMultiply, `The numbers ${a},${b},${c} have a product of ${arrayMultiply}.`];
}
